...
python -u run_algorithm.py --dataset glove-100-angular --algorithm mariadb --runs 1 --count 5 --module ann_benchmarks.algorithms.mariadb --constructor MariaDB '["angular", {"txt": "test", "M": 8, "engine": "MyISAM"}]' '[[10]]'
